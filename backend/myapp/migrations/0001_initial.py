# Generated by Django 3.2.9 on 2021-12-14 17:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available', models.BooleanField(default=True)),
                ('arrival_accomodation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='arrival_accom', to='myapp.accomadation')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.category')),
                ('trip_accomodation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trip_accom', to='myapp.accomadation')),
            ],
            options={
                'ordering': ['-id'],
            },
